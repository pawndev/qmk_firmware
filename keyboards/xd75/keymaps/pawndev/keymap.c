 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * |    `   | A      | S      | D      | F      | G      | HOME   | DEL    | PG UP  | H      | J      | K      | L      | ;      | ENTER  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 ...
 */
  ...
  [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
    ...
    KC_GRV,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_DEL,   KC_PGUP, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
 ...
 */
  ...
  [_MSE] = LAYOUT_ortho_5x15( /* MOUSE */
    ...
    _______,      _______,      _______,      _______, RGB_HUD,  RGB_HUI, _______, _______,  _______, KC_MS_BTN4, KC_MS_BTN1, KC_MS_UP,      KC_MS_BTN2,     KC_MS_WH_UP,   _______,
    _______,      _______,      _______,      _______, RGB_SAD,  RGB_SAI, _______, _______, _______, KC_MS_BTN5, KC_MS_LEFT, KC_MS_DOWN,    KC_MS_RIGHT,    KC_MS_WH_DOWN, _______,
